...
print("Да, является !") if arithmetic_progression_tnum - arithmetic_progression_snum == \
                           arithmetic_progression_snum - arithmetic_progression_fnum else print("Не является!")
