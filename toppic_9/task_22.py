...
'''
Программа работает, но ее можно улучшить, используя форматирование самих f-строк вместо символа табуляции.

Как можно добавить табуляцию (пробелы) с помощью f-строки?

В этой задаче используется символ табуляции, но не так много символов табуляции. 
Внутри цикла можно использовать только один символ табуляции
'''
